...
class BooksManager{
    ...
    Dictionary <Book>names_dictionary; /**< Manages books by name, potentially for prefix searches. */
public:
    /**
    ...
    /**
     * @brief Destructor for BooksManager, responsible for cleaning up dynamically allocated Book objects.
     */
    ~BooksManager();
};
