...
/**
 * @class Book
 * @brief Represents a book in the library system, managing its details, quantity, and borrowing status.
 * 
...
class Book{
    ...
    std::unordered_map<User*, int> borrowers; /**< Map of users who borrowed the book and the number of copies they borrowed. */
