 ...
 * @brief Defines the BorrowOperation class and related enumerations for managing book borrowing in Library System V2.
 */
...
private:
    ...
    const static char DELIM = '|'; /**< Delimiter used for serializing borrow operation data to string. */
