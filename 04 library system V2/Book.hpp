/**
 * @file Book.hpp
 * @brief Defines the Book class and related enumerations for managing book information in Library System V2.
 */
...
/**
 * @class Book
 * @brief Represents a book in Library System V2, managing its details, quantity, and borrowing status.
 * 
...
class Book{
    ...
    std::string formatted_name; /**< Formatted name of the book for display/search. */
