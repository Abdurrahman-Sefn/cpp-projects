 ...
 */
class EducationalManagemenentSystem {
    UsersManager users_manager; /**< Manages all user accounts (students and doctors). */
    CoursesManager courses_manager; /**< Manages all courses in the system. */
    ...
    // Menu handlers
    const MenuHandler<SystemMainMenuChoice> main_menu_handler; /**< Menu handler for the system's main menu. */
    const MenuHandler<EnterMenuChoice> enter_menu_handler; /**< Menu handler for the user type selection menu. */
...
public:
    /**
     * @brief Constructor for EducationalManagemenentSystem. Initializes managers and loads dummy data.
     */
