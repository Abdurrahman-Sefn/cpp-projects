 ...
 * @brief Represents a student's submitted solution to an assignment, including their answer, grade,
 * and comments.
 *
...
class AssignmentSolution {
    const Assignment* const
        assignment; /**< A constant pointer to the Assignment this solution is for. */
    const Student* const
        student;         /**< A constant pointer to the Student who submitted this solution. */
   ...
   public:
     ...
     * @param tabs The number of tabs to indent the output.
     */
    void printStudentGrade(int tabs) const;
     ...
     * @param newAnswer The new answer string.
     */
    void updateAnswer(const std::string& newAnswer);
};