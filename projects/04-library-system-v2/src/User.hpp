/**
 * @file User.hpp
 * @brief Defines the User class and related enumerations for managing user information in Library
 * System V2.
 */
...
class User {
    ...
    std::string formattedName;     /**< Formatted name of the user for display/search. */
