/**
 * @file Helper.hpp
 * @brief Provides utility functions for common tasks like indentation, menu display, and string
 * manipulation.
 */
 ...
 */
std::string getIndentation(int tabs);
 ...
 */
void showMenu(const std::vector<std::string> &options, const std::string &prompt, int tabs = 0);
